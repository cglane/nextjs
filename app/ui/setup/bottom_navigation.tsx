    ...
    return (
        <div className="w-full flex h-3/6 bg-slate-100 ">
            ...
            <div className='md:w-4/12 m-6 w-6/12'>
                <button onClick={props.handleClickListener}className="mt-4 rounded-md bg-sky-950 px-4 py-3 text-xs text-white font-bold transition-colors hover:bg-blue-400">
                    {props.buttonNext}
                </button>  
            </div>
