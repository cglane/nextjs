...
import Progress from '@/app/ui/base/progress_bar';
        ...
        <div className="relative flex h-16 items-center justify-between">
          <div className="items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex flex-shrink-0 items-center">
              ...
              />
              <span className="rounded-md px-3 py-2 text-lg font-bold text-white">
                case status
              </span>
            </div>
          </div>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            >
              ...
              <h3 className="rounded-md px-3 py-8 text-sm font-semibold text-white">
                {props.session?.user?.firm?.name}
              </h3>
            </button>
          </div>
        </div>
